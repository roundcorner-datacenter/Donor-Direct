-- Drop staging tables
drop table [Migration_METRO].dbo.rC_Bios__Contact_Address__c_Load;
...
Where  a.Donor!='' and a.lname!='' and right(c.External_Id__C,2)!='-2'
)

select * 
INTO [Migration_METRO].dbo.[rC_Bios__Contact_Address__c_Load]
...
---check errors
--select error from [Migration_METRO].dbo.rC_Bios__Contact_Address__c_Load  where error not like '%Op%'
